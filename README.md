...
## How to run the training code?
  ...
  3) **Step 3: run the train code**: The jupyter notebook script provide some visualization steps to make sure the training process goes correctly 
