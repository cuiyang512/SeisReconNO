...
## How to run the training code?
  ...
  2) **Step 2: QC and patches generation**: You can simply run [patch_generation_field_cubes.ipynb](https://github.com/cuiyang512/SeisReconNO/blob/main/Data_processing/patch_generation_field_cubes.ipynb) for each cube and to save the .npy files of the field cubes.
